...
- [AI駆動開発ベストプラクティス](../../docs/guides/ai-driven-development.md) - AIツール活用のベストプラクティス
- [プロジェクト指示ファイル](../../COPILOT.md) - AI向け指示書
- [カスタムコマンド](../../.claude/commands/) - Claude Codeカスタムコマンド
...
| 日付 | バージョン | 変更内容 |
|------|-----------|---------|
| 2026-01-06 | 1.1.0 | AI駆動開発ベストプラクティスへの参照を追加 |
